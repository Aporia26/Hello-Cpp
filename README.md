...
A structured repository tracking my programming evolution from foundational computational logic, switch matrices, and system solvers up to rendering hardware graphics viewports.

---

## 🗺️ Learning Roadmap & Milestones

Each source file inside the `src/` directory maps out a specific milestone during my software engineering journey, built while mastering core concepts through Bro Code's comprehensive deep-dives:

*   **`01_temperature_converter.cpp`**: Core focus on functional arithmetic parsing, variable initialization, and clear console I/O formatting.
*   **`Quadratic.cpp`**: Implementing complex logic handling using condition forks and importing the standard `<cmath>` compilation module to process imaginary roots.
...
## ⚙️ Environment & Setup
- **Language Stack:** C++
- **Graphics Framework:** SFML 3
- **Tools:** VS Code + Native Compiler Toolchains (MinGW/GCC)

---
*Documenting my self-directed programming progressions during Semester 1 of B.Tech CSE.*
